# Generated by Django 5.0 on 2024-11-21 17:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dish', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='app.dish')),
                ('order', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='dishes', to='app.order')),
            ],
        ),
        migrations.CreateModel(
            name='Profession',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date(2024, 11, 21))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.PROTECT, to='app.restaurant')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
